...
## Some notes about building it:
 ...
 - One thing I would've done different with more time is structuring the database better. Notably, .mid songs would definitely go in a storage bucket rather than be saved directly in a table.
